...
// This file was fetched from: https://github.com/mcci-catena/arduino-lmic
...
/**
 * @brief Build a simple Unconfirmed Data Up for LoRaWAN standard
 * 
 * @param payload Your source data to send
 * @param payload_len The length of your source data
 * @param FCnt LoRaWAN Frame Counter
 * @param target_buffer Buffer to contain built packet result
 * @param NwkSKey LoRaWAN Network Session Key (MSB Array)
 * @param AppSKey LoRaWAN Application Session Key (MSB Array)
 * @param devAddr LoRaWAN Device Address
 * @param FPort LoRaWAN Frame Port (1 - 255).
 *              If you wish to build MAC Command Packet (FPort = 0), consider to use another function/library.
 * 
 * @return uint8_t The length of LoRaWAN encoded packet result.
 *                 Normally, this length equals to payload_len + 9 (MHDR + FHDR + FPORT) + 4 (MIC)
 */
